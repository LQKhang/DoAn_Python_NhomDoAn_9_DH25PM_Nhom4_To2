...
tree.column("Tên sản phẩm", width=130, anchor="center")
tree.column("Phân loại", width=130, anchor="center")
tree.column("Giá", width=70, anchor="center")
tree.column("Số lượng", width=70, anchor="center")
